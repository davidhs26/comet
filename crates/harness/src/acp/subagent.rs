...
pub(crate) fn tag(parent: &str, event: AgentEvent) -> AgentEvent {
    AgentEvent::Subagent {
...
pub(crate) fn done_status(status: &str) -> DoneStatus {
    match status {
...
pub(crate) struct TailFinish {
    pub(crate) status: DoneStatus,
...
impl TailReader {
    ...
    pub(crate) fn read_new(&mut self) -> Vec<Value> {
